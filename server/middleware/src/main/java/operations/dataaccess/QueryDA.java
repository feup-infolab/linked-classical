...
public class QueryDA {
    ...
    public List<MusicalWork> getComposerWorks(String composerId) {
        ...
        for (HashMap<String, String> triple : associatedTriples) {
            ...
            if (URI.equals(lastURI)) {
                musicalWork = musicalWorks.get(musicalWorks.size() - 1);
                //musicalWork.addTriple(triple);
            }
            else {
                musicalWork.setURI(URI);
                //musicalWork.addTriple(triple);
