...
@section('title')
  <title> Create Composer </title>
@endsection

@section('scripts')
  <script src="{{ asset('js/createComposer.js') }}" defer></script>
@endsection
  ...
  <section class="mx-6 mx-auto py-6 px-2 xl:px-4 max-w-screen-lg">
    ...
    <div class="min-w-100">
      ...
      <article class="mt-5 mb-6 max-w-screen-lg">
        <hr class="my-4">
        @include('web.composer.components.form_fields.uri')
        <hr class="my-4">
        @include('web.composer.components.form_fields.name')
      </article>
    ...
    <div class="my-8 text-sm flex  float-right">
      ...
      <button type="submit" id="save_button" class="create p-2 px-3 rounded bg-gray-dark text-white">Create Composer</button>
    </div>
